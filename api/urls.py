...
from api.views import targetview, keywordview, articleview, categoryview, centerview, adminviews
...
urlpatterns = [
    ...
    path('admin/user', adminviews.UserView.as_view(), name='user增删改'),
    path('admin/userfilter', adminviews.UserFilterView.as_view(), name='user查'),
